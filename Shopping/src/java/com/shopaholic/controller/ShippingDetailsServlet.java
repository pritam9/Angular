 ...
 * @author Pritam
 */
@WebServlet(name = "ShippingDetailsServlet", urlPatterns = {"/ShippingDetailsServlet"})
public class ShippingDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ShippingType> types = new ProductDaoImp().getShippingTypes();
        
            myResponse.setData(types);
            myResponse.setMessage("Operation Successful");
