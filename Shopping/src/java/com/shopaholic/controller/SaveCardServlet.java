 ...
 * @author Pritam
 */
@WebServlet(name = "SaveCardServlet", urlPatterns = {"/SaveCardServlet"})
public class SaveCardServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            CreditCard details = mapper.readValue(request.getInputStream(), new TypeReference<CreditCard>(){});
        ...
        if(new CustomerDaoImpl().saveCardDetails(details,email)){
