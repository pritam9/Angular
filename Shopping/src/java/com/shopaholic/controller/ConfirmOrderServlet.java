...
public class ConfirmOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ConfirmDetails details = mapper.readValue(request.getInputStream(), new TypeReference<ConfirmDetails>(){});
        ...
        if(new ProductDaoImp().saveCartDetails(details,email,cartId)){
