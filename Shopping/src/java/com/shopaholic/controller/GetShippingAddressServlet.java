 ...
 * @author Pritam
 */
@WebServlet(name = "GetShippingAddressServlet", urlPatterns = {"/GetShippingAddressServlet"})
public class GetShippingAddressServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Address card = new CustomerDaoImpl().getAddress(empoyeeId);
        if (card != null) {
            myResponse.setData(card);
            ...
            myResponse.setMessage("Error Retriving");
